...
public class Constants {
    ...
    public static final String URL_DisApp_SEARX = "https://trydex.tk";
    ...
    public static final String URL_DisApp_HOWTO = "https://github.com/LencoDigitexer/trydex/wiki";
    ...
    public static final String URL_DISROOT = "https://trydex.tk";
    ...
    public static final String URL_TRANSLATE = "https://github.com/LencoDigitexer/trydex_app";
    public static final String URL_SOURCE = "https://github.com/LencoDigitexer/trydex_app";
    public static final String URL_BUGS = "https://github.com/LencoDigitexer/trydex_app/issues";
    public static final String URL_XMPP = "xmpp:disroot@chat.disroot.org?join";
    public static final String URL_SUPPORT = "mailto:lencodigitexer@vk.com";
